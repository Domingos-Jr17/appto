/**
 * Standalone test: Z.AI (GLM) provider test (pure Node.js, no dependencies)
 * Tests Z.AI API directly to verify content generation works.
 *
 * Usage: node scripts/test-zai-generation.mjs
 */
...
async function testZAIDirect() {
  console.log("=== Testing Z.AI (GLM) Direct API Call ===\n");
...
- Produza JSON estritamente válido`,
  ...
  try {
    ...
    try {
      ...
      console.log("\n=== RESULT: Z.AI Content generation works! ===");
    } catch (e) {
      console.log("\n=== JSON Parsing: FAILED ===");
