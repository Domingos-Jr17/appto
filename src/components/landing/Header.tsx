      ...
      >
        <div
          className={cn(
            ...
            isScrolled
              ? "bg-background/85 backdrop-blur-2xl shadow-2xl shadow-primary/10 border border-border/60"
              : "bg-background/60 backdrop-blur-xl shadow-xl shadow-primary/5 border border-border/40"
          )}
        >
