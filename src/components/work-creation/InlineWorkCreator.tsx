  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <AnimatePresence mode="wait">
        {state === "EMPTY" ? (
          <motion.div key="empty" {...TRANSITION} className="space-y-8">
            {/* Greeting */}
          ...
          <motion.div key="filling" {...TRANSITION} className="space-y-6">
            {/* Header */}
            ...
            <div className="space-y-1">
              <Label htmlFor="filling-title" className="text-xs text-muted-foreground">
                Tema do trabalho
              </Label>
              <Input
                id="filling-title"
                ...
                placeholder="Ex.: Impacto do microcrédito..."
              />
            </div>
